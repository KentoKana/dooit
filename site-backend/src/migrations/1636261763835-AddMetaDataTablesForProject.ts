...
export class AddMetaDataTablesForProject1636261763835 implements MigrationInterface {
    name = 'AddMetaDataTablesForProject1636261763835'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`IDX_0ef8601acfe2cb4634753d4d2d\` ON \`doo\`.\`projects\``);
        ...
        await queryRunner.query(`ALTER TABLE \`doo\`.\`projects\` CHANGE \`flairId\` \`flairId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`doo\`.\`project_items\` ADD CONSTRAINT \`FK_075bc125384418c6da0a624d808\` FOREIGN KEY (\`projectId\`) REFERENCES \`doo\`.\`projects\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_0ef8601acfe2cb4634753d4d2d\` ON \`doo\`.\`projects\` (\`flairId\`)`);
    }
